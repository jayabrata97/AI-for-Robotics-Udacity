...
# Later change the heuristic from L2  
...
def search(grid,init,goal,cost):
    ...
    if  found is True: 
        ...
        print("len of plan:",len(final_plan))    
        print(final_plan)
